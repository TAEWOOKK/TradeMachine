...
| 09:05~15:25 | Scan (5분 간격) | 매도/매수 판단 및 실행 |
| 15:28 (금) | Friday close | 보유 종목 전량 청산 (주말 갭 리스크 방지) |
...
**매수 조건** (모두 충족 시):
1. KOSPI > MA(20) (시장 필터)
2. 종목 품질 필터 (최소 주가 5,000원, 거래대금 10억+, 시총 5,000억+)
3. 골든크로스 발생 (MA5 > MA20) + 7일 내 + 3일 유지 확인
4. 교차일 거래량 > MA(20) 거래량 × 1.5
5. 30 ≤ RSI(14) ≤ 70

**매도 조건** (우선순위):
1. 손절: 수익률 ≤ -5%
2. 익절: 수익률 ≥ +15%
3. 트레일링 스탑: +8% 도달 후 고점 대비 4% 하락
4. 보유 기간 초과: 영업일 20일 초과
