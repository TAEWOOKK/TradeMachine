...
총 매매:     54번 (27번 매수, 27번 매도)
이익 매매:   10번 (합계: +132,700원)
손해 매매:   15번 (합계: -340,350원)
고점하락매도:  3번 (큰 손해 전에 빠져나옴)
...
4차 (단타 시작):     -36,950원  ← 줄었지만 여전히 마이너스
5차 (단타+고점추적):  +8,500원  ← 드디어 플러스! (지켜보는 중)
```
...
5. **너무 빨리 파는 것도 문제** — 삼성전기 15분 만에 팔림 (일반적인 등락에 과민 반응)
6. **당일 매매가 그나마 안전** — 밤/주말 리스크 없음
7. **고점 추적이 효과 있다** — 올라갈 때 기다리고, 떨어지면 빠지니까 이익을 지킬 수 있음
...
**자금 배분**:
- 최대 동시 보유 8종목 (`MAX_HOLDING_COUNT=8`)
- 종목당 투자금 = 가용 현금 / 빈 슬롯 수 (약 125만원)
- 일일 매수 횟수 무제한 (`MAX_DAILY_BUY_COUNT=0`)
